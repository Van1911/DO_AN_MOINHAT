...
//public class myTicketAdapter extends RecyclerView.Adapter<myTicketAdapter.TicketViewHolder> {
//
...
//    }
//
//    public myTicketAdapter(List<Ticket> mListTicket,IClickListener listener) {
